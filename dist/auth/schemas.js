...
const disposable_domains_js_1 = require("./disposable-domains.js");
const emailSchema = zod_1.z
    .string()
    .email('E-mail inválido')
    .transform((v) => v.toLowerCase().trim())
    .refine((v) => !(0, disposable_domains_js_1.isDisposableDomain)(v), 'E-mail temporário não é permitido');
...
exports.loginSchema = zod_1.z.object({
    email: zod_1.z.string().email('E-mail inválido').transform((v) => v.toLowerCase().trim()),
