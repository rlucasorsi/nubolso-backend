...
exports.DISPOSABLE_DOMAINS = void 0;
exports.isDisposableDomain = isDisposableDomain;
exports.DISPOSABLE_DOMAINS = new Set([
    ...
    '10minutemail.de', '10minutemail.eu', '10minutemail.info', '10minutemail.us',
    '10minemail.com', '20minutemail.com', '2prong.com',
    'altmails.com', 'anonbox.net', 'antichef.com', 'antichef.net',
    'armyspy.com', 'asdasd.nl',
    'bccto.me', 'beefmilk.com', 'bigstring.com', 'binkmail.com',
    'bit2tube.com', 'bladesmail.net', 'bloofus.com', 'bobmail.info',
    'bodhi.lawlita.com', 'bofthew.com', 'boun.cr', 'bouncr.com',
    'breakthru.com', 'brefmail.com', 'brennendesreich.de', 'bspamfree.org',
    'bugmenot.com', 'bumpymail.com', 'burstmail.info',
    'casualdx.com', 'centermail.com', 'centermail.net', 'chammy.info',
    'cheatmail.de', 'chogmail.com', 'choicemail1.com', 'clixser.com',
    'cmail.net', 'cmail.org', 'coieo.com', 'compositeemails.com',
    'consumo.mobi', 'cool.fr.nf', 'correo.blogos.net', 'cosmorph.com',
    ...
    'disposableinbox.com', 'disposeamail.com', 'dispostable.com',
    'dodgeit.com', 'dodgmail.de', 'donemail.ru', 'dontreg.com',
    'dontsendmespam.de', 'drdrb.com', 'drdrb.net', 'dump-email.info',
    'dumpandfuck.com', 'dumpmail.de', 'dumpyemail.com', 'durandinterstellar.com',
    'e4ward.com', 'easytrashmail.com', 'einmalmail.de', 'einrot.com',
    'einrot.de', 'eintagsmail.de', 'email60.com', 'emailgo.de',
    ...
    'emkei.tk', 'emz.net', 'enterto.com', 'ephemail.net', 'etranquil.com',
    'etranquil.net', 'etranquil.org', 'evopo.com', 'explodemail.com',
    'express.net.ua', 'extremail.ru', 'eyepaste.com',
    'fakeinbox.com', 'fakeinformation.com', 'fakemail.fr', 'fakemailz.com',
    'fammix.com', 'fansworldwide.de', 'fantasymail.de', 'fast-email.com',
    'fast-mail.fr', 'fastacura.com', 'fastchevy.com', 'fastchrysler.com',
    'fastem.com', 'fastemail.us', 'fastemailer.com', 'fastemails.us',
    'fastermail.com', 'fastimap.com', 'fastmazda.com', 'fastmitsubishi.com',
    'fastnissan.us', 'fastsuzuki.com', 'fasttoyota.com', 'fastsubaru.com',
    'fauxmail.com', 'fbi.cjb.net', 'fbi.hu', 'fdd.mn',
    'fightallspam.com', 'filzmail.com', 'filzmail.de', 'fivemail.de',
    'fixmail.tk', 'fizmail.com', 'fleckens.hu', 'flurred.com',
    'flyspam.com', 'footard.com', 'forgetmail.com', 'fr33mail.info',
    'frapmail.com', 'freundin.ru', 'front14.org', 'fudgerub.com',
    'fux0ringduh.com', 'fwat.org', 'garbagemail.org', 'gardenscape.ca',
    'gavar.se', 'gawab.com', 'gehensiemirnichtaufdensack.de', 'get1mail.com',
    'get2mail.fr', 'getairmail.com', 'getmails.eu', 'getonemail.com',
    'getonemail.net', 'ghosttexter.de', 'girlmail.com', 'gishpuppy.com',
    'goemailgo.com', 'gorillaswithdirtyarmpits.com', 'gowikibooks.com',
    ...
    'h.mintemail.com', 'h8s.org', 'hailmail.net', 'happypuppy.com',
    'hartbot.de', 'hat-geld.de', 'hatespam.org', 'herp.in',
    'hidemail.de', 'hidzz.com', 'hmail.us', 'hopemail.biz',
    ...
    'infocom.zp.ua', 'insorg-mail.info', 'instant-mail.de',
    'instantemailaddress.com', 'instantmail.fr', 'ip6.li',
    'Irish2me.com', 'iwi.net', 'jetable.com', 'jetable.fr.nf',
    'jetable.net', 'jetable.org', 'jonathanspetcock.com', 'junk.to',
    'junkmail.com', 'junkmail.ga', 'junkmail.gq', 'kasmail.com',
    'kaspop.com', 'keepmymail.com', 'killmail.com', 'killmail.net',
    'kir.ch.tc', 'klassmaster.com', 'klassmaster.net', 'klzlk.com',
    'koszmail.pl', 'kurzepost.de', 'lawlita.com', 'lazyinbox.com',
    ...
    'mailfsck.com', 'mailguard.me', 'mailimate.com', 'mailin8r.com',
    ...
    'mailjunk.tk', 'mailme.ir', 'mailme.lv', 'mailme24.com',
    ...
    'mailsiphon.com', 'mailslite.com', 'mailslitting.com', 'mailsmart.info',
    'mailsnull.com', 'mailsomething.com', 'mailspam.me', 'mailspam.xyz',
    'mailspect.com', 'mailsucker.net', 'mailtemporal.com', 'mailtemporaire.com',
    'mailtemporaire.fr', 'mailtome.de', 'mailtothis.com', 'mailtrash.net',
    ...
    'monmail.fr.nf', 'monumentmail.com', 'mox.pp.ua', 'mswork.ru',
    'mt2009.com', 'mt2014.com', 'mucinowski.com', 'munoubeku.com',
    'munsterschule.de', 'mx0.wwwnew.eu', 'my10minutemail.com',
    ...
    'nabuma.com', 'netzidiot.de', 'neverbox.com', 'nice-4u.com',
    ...
    'oneoffmail.com', 'onewaymail.com', 'online.ms', 'opayq.com',
    'ordinaryamerican.net', 'otherinbox.com', 'ourklips.com', 'outlawspam.com',
    'ovpn.to', 'owlpic.com', 'pancakemail.com', 'paplease.com',
    'payspade.com', 'pepbot.com', 'pjjkp.com', 'plexolan.de',
    'poofy.org', 'pookmail.com', 'postalmail.biz', 'privacy.net',
    ...
    'sandelf.de', 'saynotospams.com', 'schafmail.de', 'schrott-mail.de',
    ...
    'sofimail.com', 'sogetthis.com', 'sofort-mail.de', 'soisz.com',
    'sol.dk', 'spam.la', 'spam.su', 'spam4.me', 'spamail.de',
    ...
    'spaml.de', 'spammotel.com', 'spammy.host', 'spamnot.com',
    'spamoff.de', 'spamsalad.in', 'spamslicer.com', 'spamspot.com',
    'spamstack.net', 'spamthis.co.uk', 'spamthisplease.com', 'spamtrap.ro',
    ...
    'sweetxxx.de', 'tafmail.com', 'tagyourself.com', 'techemail.com',
    ...
    'tempEmail.com', 'tempemail.biz', 'tempemail.co.za', 'tempemail.com',
    ...
    'thankyou2010.com', 'thc.st', 'thedoghousemail.com', 'thelimestones.com',
    'thisisnotmyrealemail.com', 'throwam.com', 'throwam.net',
    'throwam.org', 'throwaway.email', 'throwaways.info', 'tilien.com',
    'tittbit.in', 'tmail.com', 'tmail.io', 'tmail.ws',
    'tmailinator.com', 'toiea.com', 'tongpadiamond.com', 'tradermail.info',
    'trash-mail.at', 'trash-mail.com', 'trash-mail.de', 'trash-mail.ga',
    'trash-mail.io', 'trash-mail.me', 'trash2009.com', 'trashemail.de',
    'trashmail.at', 'trashmail.com', 'trashmail.de', 'trashmail.io',
    'trashmail.me', 'trashmail.net', 'trashmail.org', 'trashmailer.com',
    'trashmailt.com', 'trashymail.com', 'trbvm.com', 'trollbot.de',
    'turual.com', 'twinmail.de', 'tyldd.com',
    'uggsrock.com', 'umail.net', 'upliftnow.com', 'uplipht.com',
    'uroid.com', 'utiket.us', 'uuid.cc',
    'venompen.com', 'veryrealemail.com', 'viditag.com',
    'vipmail.name', 'vipmail.pw', 'virussend.de',
    ...
    'wegwerfemail.org', 'wh4f.org', 'whyspam.me', 'willhackforfood.biz',
    ...
    'xmaily.com', 'xox.jp', 'xyzfree.net', 'yapped.net',
    'yeah.net', 'yep.it', 'yogamaven.com', 'yomail.info',
    'yopmail.com', 'yopmail.fr', 'yopmail.pp.ua', 'yourdomain.com',
...
function isDisposableDomain(email) {
    ...
    return domain ? exports.DISPOSABLE_DOMAINS.has(domain) : false;
}
